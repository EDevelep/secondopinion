...
import org.secondopinion.pharmacy.PharmacyServiceApplication;
...
@SpringBootTest(classes = { PharmacyServiceApplication.class })
public class PharmacyApplactionTest {
	@Autowired
	...
	public void sessionId() {
		...
		try {
			...
			sessionId = CachedSessionToken.createSessionId(appProperties.getSsu().getCreateTokenUri(),
					"jitendra@qontrack.com", SecondOpinionModuleEnum.PHARMACY.name(), 12L,
