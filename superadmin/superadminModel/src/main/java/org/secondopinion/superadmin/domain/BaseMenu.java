...
@MappedSuperclass 
public abstract class BaseMenu extends BaseDomainObject<Integer> {
	...
	public void validate(boolean validatePk){
		...
		if((this.menuName != null) && (this.menuName.length()>45)){
			 list.add(new ValidationMessage("Field " + FIELD_menuName+  " cannot be longer than: " + 45));
		}
		...
		if((this.moduleName != null) && (this.moduleName.length()>45)){
			 list.add(new ValidationMessage("Field " + FIELD_moduleName+  " cannot be longer than: " + 45));
		}
...
;
	...
	public Object clone() throws CloneNotSupportedException {
		...
		menu.setModuleName(getModuleName());
		menu.setActive(getActive());
		menu.setCreatedDate(getCreatedDate());
		//afterClone(menu);
		return menu;
	}
}