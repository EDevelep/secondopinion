...
import org.payment.gateway.razorpay.Notes;
...
public class FetchPayment {
	...
	public  static FetchPayment getDetails(Payment payment) {
		...
		if (fetchPaymentData.getBank() != null) {
		...
		if (fetchPaymentData.getInvoice_id() != null) {
		...
		if (fetchPaymentData.getRefund_status() != null) {
