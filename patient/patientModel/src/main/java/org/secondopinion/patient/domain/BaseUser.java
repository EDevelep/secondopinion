...
public abstract class BaseUser extends BaseDomainObject<Long> {
	...
	public static final String FIELD_addedBy = "addedBy";
	public static final String FIELD_roleId = "roleId";
	public static final String FIELD_dependent = "dependent";
	...
	public boolean equals(Object o) {
		...
		if (ObjectUtil.isEqual(getUserName(), other.getUserName())
				...
				&& ObjectUtil.isEqual(getDependent(), other.getDependent())
	...
	public void validate(boolean validatePk) {
		...
		if ((this.emergencycontact != null) && (this.emergencycontact.length() > 45)) {
			list.add(new ValidationMessage("Field " + FIELD_emergencycontact + " cannot be longer than: " + 45));
		}
	...
	public String toString() {
		...
		str.append("dependent = " + dependent + "\n");
	...
	public Object clone() throws CloneNotSupportedException {
		...
		user.setDependent(getDependent());
