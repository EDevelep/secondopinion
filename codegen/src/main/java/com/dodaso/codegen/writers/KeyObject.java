...
//import com.mysql.jdbc.StringUtil;

public class KeyObject extends BaseObjectWriter {
	
	private String fileContents =null;
	
	public KeyObject() {
		fileContents = FileUtil.getFileContentsAsString(KeyObject.class.getResource("Key.txt").getFile());
	}

	public String getFileName(CodeGenProperties codeGenProperties, TableObject object) {
		return codeGenProperties.getDomainObjectDirectory()+ File.separator  + object.getTableClassName() + "Key.java";		
	}
