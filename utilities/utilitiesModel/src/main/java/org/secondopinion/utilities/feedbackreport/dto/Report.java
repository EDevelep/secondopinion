...
import org.secondopinion.utilities.feedbackreport.domain.BaseReport;
import org.secondopinion.utilities.feedbackreport.dto.ReportParameter.PARAMETER;
...
public class Report extends BaseReport{
	...
	public Map<String, Object> prepareReportParams() {
		...
		for(ReportParameter parameter : reportParameters){
			...
			Object paramVal = param.getParamValue(this);
