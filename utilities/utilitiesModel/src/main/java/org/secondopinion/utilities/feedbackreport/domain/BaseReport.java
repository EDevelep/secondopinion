...
// 	@NotNull
	...
	public boolean equals(Object o){
		...
		if(
			...
			ObjectUtil.isEqual(getHeader(), other.getHeader()) && 
	...
	public void validate(boolean validatePk){
		...
		if((this.columns != null) && (this.columns.length()>250)){
			 list.add(new ValidationMessage("Field " + FIELD_columns+  " cannot be longer than: " + 250));
		}

		if((this.conditions != null) && (this.conditions.length()>150)){
			 list.add(new ValidationMessage("Field " + FIELD_conditions+  " cannot be longer than: " + 150));
		}

		if((this.groupColumns != null) && (this.groupColumns.length()>150)){
			 list.add(new ValidationMessage("Field " + FIELD_groupColumns+  " cannot be longer than: " + 150));
		}
		...
		if((this.transposeData != null) && (this.transposeData.length()>150)){
			 list.add(new ValidationMessage("Field " + FIELD_transposeData+  " cannot be longer than: " + 150));
		}

		if((this.keyColumns != null) && (this.keyColumns.length()>150)){
			 list.add(new ValidationMessage("Field " + FIELD_keyColumns+  " cannot be longer than: " + 150));
		}
