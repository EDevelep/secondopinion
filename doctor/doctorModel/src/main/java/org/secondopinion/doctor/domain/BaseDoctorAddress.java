...
@MappedSuperclass
public abstract class BaseDoctorAddress extends BaseDomainObject<Long> {
	...
	public boolean equals(Object o) {
		...
		if (o == null || getClass() != o.getClass())
			return false;
		BaseDoctorAddress other = (BaseDoctorAddress) o;
		if (ObjectUtil.isEqual(getDoctorId(), other.getDoctorId()) && ObjectUtil.isEqual(getActive(), other.getActive())
	...
	public Object clone() throws CloneNotSupportedException {
		...
		address.setDoctorId(getDoctorId());
