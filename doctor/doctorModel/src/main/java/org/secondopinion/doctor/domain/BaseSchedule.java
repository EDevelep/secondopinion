...
public abstract class BaseSchedule extends BaseDomainObject<Long> {
	...
	public boolean equals(Object o) {
		...
		if (ObjectUtil.isEqual(getDoctorId(), other.getDoctorId())
				...
				&& ObjectUtil.isEqual(getDay(), other.getDay()) && ObjectUtil.isEqual(getMonth(), other.getMonth())
	...
	public Object clone() throws CloneNotSupportedException {
		...
		schedule.setDoctorId(getDoctorId());
		...
		schedule.setAssociateEntityId(getAssociateEntityId());
		schedule.setAssociateEntityType(getAssociateEntityType());
		schedule.setAssociateEntityName(getAssociateEntityName());
