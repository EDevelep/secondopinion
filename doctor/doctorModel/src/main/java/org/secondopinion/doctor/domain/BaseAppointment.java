...
public abstract class BaseAppointment extends BaseDomainObject<Long> {
	...
	public void validate(boolean validatePk){
		...
		if((this.doctorName != null) && (this.doctorName.length()>255)){
			 list.add(new ValidationMessage("Field " + FIELD_doctorName+  " cannot be longer than: " + 255));
		}
...
;
		...
		str.append("amountPaidStatus = " + amountPaidStatus + "\n");
	...
	public Object clone() throws CloneNotSupportedException {
		...
		appointment.setDoctorId(getDoctorId());
		appointment.setDoctorName(getDoctorName());
