...
public class StringUtil {
	...
	public static List<String> trimEmptySpaceAndSplitWithDelimeter(String value) {

		return trimEmptySpaceAndSplitWithDelimeter(value, ","); 
	}

	public static List<String> trimEmptySpaceAndSplitWithDelimeter(String value, String delimeter) {

		value = trimEmptySpace(value);
		List<String> notAuthorizedApisWithComma = new ArrayList<>(Arrays.asList(value));

		if(value.contains(",")) {
			notAuthorizedApisWithComma.clear();
			String[] timingsOfDaySplitWithComma =  value.split(",");
			notAuthorizedApisWithComma = Arrays.stream(timingsOfDaySplitWithComma).distinct().collect(Collectors.toList());
		}
		return notAuthorizedApisWithComma;
	}

	public static String trimEmptySpace(String value) {
